...
impl OptimizedOps {
    ...
    #[wasm_bindgen]
    pub fn fused_relu_add(&self, input: &WasmTensor, bias: &WasmTensor) -> Result<WasmTensor, JsValue> {
    ...
    #[wasm_bindgen]
    pub fn conv1d(&self, input: &WasmTensor, kernel: &WasmTensor, stride: usize) -> Result<WasmTensor, JsValue> {
...
impl WasmMemoryPool {
    ...
    pub fn new() -> WasmMemoryPool {
        ...
        for _i in 0..20 {  // Up to 2^20 elements
            pools.push(Vec::new());
        }
