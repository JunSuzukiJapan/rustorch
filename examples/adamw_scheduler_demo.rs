...
use rustorch::optim::{
    AdamW, CosineAnnealingLR, LRScheduler, Optimizer, PlateauMode, ReduceLROnPlateau, StepLR,
};
...
fn main() {
    ...
    let mut cosine_scheduler = CosineAnnealingLR::new(AdamW::default_params(0.1), 10, 0.001);
