...
fn main() {
    ...
    let sample_pred = Variable::new(Tensor::from_vec(vec![0.3, 0.7, 0.9, 0.1], vec![4]), false);
    let sample_target = Variable::new(Tensor::from_vec(vec![0.0, 1.0, 1.0, 0.0], vec![4]), false);
