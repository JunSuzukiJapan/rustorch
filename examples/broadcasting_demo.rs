...
fn main() {
    ...
    println!("Tensor1 shape: {:?}, data: {:?}", tensor1.shape(), tensor1.as_slice().unwrap());
    println!("Tensor2 shape: {:?}, data: {:?}", tensor2.shape(), tensor2.as_slice().unwrap());
    ...
    println!("Small tensor shape: {:?}, data: {:?}", small_tensor.shape(), small_tensor.as_slice().unwrap());
