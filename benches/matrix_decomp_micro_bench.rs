...
fn manual_timing_benchmark() {
    ...
    for size in sizes {
        ...
        println!("  SVD:    {:.2} µs/op", svd_time.as_nanos() as f64 / iterations as f64 / 1000.0);
        ...
        println!("  QR:     {:.2} µs/op", qr_time.as_nanos() as f64 / iterations as f64 / 1000.0);
        ...
        println!("  LU:     {:.2} µs/op", lu_time.as_nanos() as f64 / iterations as f64 / 1000.0);
        ...
        println!("  Symeig: {:.2} µs/op", symeig_time.as_nanos() as f64 / iterations as f64 / 1000.0);
        ...
        println!("  Eig:    {:.2} µs/op", eig_time.as_nanos() as f64 / iterations as f64 / 1000.0);
    }
