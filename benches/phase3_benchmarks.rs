...
use rustorch::nn::{
    geglu, glu, reglu, swiglu, ConvTranspose1d, ConvTranspose2d, ConvTranspose3d, InstanceNorm1d,
...
fn bench_glu_variants(c: &mut Criterion) {
    ...
    let input = Variable::new(Tensor::from_vec(input_data, vec![1, 1024]), false);
