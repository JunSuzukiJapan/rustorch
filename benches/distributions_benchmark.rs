...
fn bench_batch_distributions(c: &mut Criterion) {
    ...
    for batch_size in batch_sizes.iter() {
        ...
        group.bench_with_input(BenchmarkId::new("batch_normal_sampling", batch_size), batch_size, |b, &batch_size| {
            b.iter(|| {
        ...
        group.bench_with_input(BenchmarkId::new("batch_bernoulli_sampling", batch_size), batch_size, |b, &batch_size| {
            b.iter(|| {
