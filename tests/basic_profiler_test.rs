...
mod basic_profiler_tests {
    ...
    fn test_basic_metrics_collection() {
        ...
        for i in 1..=5 {
            metrics.entry("test_metric".to_string())
    ...
    fn test_basic_benchmark() {
        ...
        println!("Benchmark results: mean={:.2}ns, std_dev={:.2}ns", mean, std_dev);
    }
    ...
    fn test_basic_performance_analysis() {
        ...
        println!("Trend analysis: slope={:.2}, intercept={:.2}", slope, intercept);
    }
    ...
    fn test_basic_system_monitoring() {
        ...
        let handle = std::thread::spawn(move || {
            for i in 1..=5 {
                ...
                metrics_clone.lock().unwrap().push((cpu_usage, memory_usage));
        ...
        println!("System monitoring: collected {} data points", collected_metrics.len());
    }
    ...
    fn test_basic_alert_system() {
        ...
        println!("Alert system: {} alerts triggered", 
